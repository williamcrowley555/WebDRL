            ...
            for (let i = 0; i < data.length; i++) {
              ...
              htmlData +=
                ...
                <td class='cell'>\
                  ...
                  data[i].maKhoa + "' >Đặt lại mật khẩu</button>\
                  ...
                  data[i].maKhoa + "' data-tenKhoa = '" + data[i].tenKhoa +  "' >Chỉnh sửa</button>\</td>\
                </tr>";
            }
...
function DatLaiMatKhau_Khoa() {
  ...
  if (_DLMK_maKhoa == "" | _input_MatKhauMoi == "" || _input_NhapLaiMatKhauMoi == "") {
        ...
        success: function (result_Khoa) {
          ...
          $.ajax({
            ...
            success: function (result_Create) {
              ...
              Swal.fire({
                icon: "success",
                title: "Đặt lại mật khẩu thành công Khoa mã "+ _input_maKhoa +"!",
                text: "",
                timer: 2000,
                timerProgressBar: true,
              });
...
function ThemMoi_Khoa() {
  ...
  if (_add_input_MaKhoa == "" || _add_input_TenKhoa == "" || _add_input_TaiKhoanKhoa == ""
  || _add_input_MatKhau == "" || _add_input_NhapLaiMatKhau == "") {
    ThongBaoLoi("Vui lòng nhập đầy đủ thông tin!");
  } else {
