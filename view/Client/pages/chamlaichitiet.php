...
<div style="width: 100%;">
            ...
            <div style="padding: 48px;">
                ...
                <form id='formDanhGiaDRL' method="post" enctype="multipart/form-data">
                    <div class="form-outline mb-4">
                        ...
                        <button type="submit" class="btn btn-primary" style="width: auto;" onclick="return chamDiemRenLuyen_ChamLai();">Chấm điểm</button>
    ...
    <script>
        ...
        function chamDiemRenLuyen_ChamLai() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        if (checkValidateInput()) {
                            ...
                            formData.append("coVanDuyet", 0);
                            formData.append("khoaDuyet", 0);

                            //Phiếu rèn luyện trước
                            $.ajax({
                                                ...
                                                for (var q = 0; q < resultGET[index_GET].length; q++) {
                                                    ...
                                                    $("#tbody_noiDungDanhGia").find("input").each(function() {
                                                        ...
                                                        if (tieuChi == "TC2") {
                                                            ...
                                                            if (_inputMaTieuChi2 == maTieuChi2){
                                                        ...
                                                        if (tieuChi == "TC3") {
                                                            ...
                                                            if (_inputMaTieuChi3 == maTieuChi3){
